<!-- <div id="app"> -->
		...
		<div>
			...
			<ul id="navigation">
				...
				<li id="softButton"  class="selected">
...
<div id="contents">
		<div id="about" class="body">
			<h1>Softwares</h1>
			<h4><a href="http://discovery.informatics.iupui.edu/SPINNER/">SPINNER</a></h4>
			...
			<h4><a href="http://discovery.informatics.iupui.edu/SPINNER/">GEMINE</a></h4>	
					<p>
						GEMINE stands for Gene Expression Mutation Interaction Neighborhood Exploration. This database is developed to store the gene significance data in cancers based on the gene expression and mutations. The raw data has been taken from COSMIC and TCGA and the differentially expressed genes have been filtered and prioritized on the basis of their SPINNER rank. We also calculate the similarity between the genes on the basis of the gene expression data from TCGA and mutation data from COSMIC. We also developed the web application, which is used to browse through the database using PHP and javascript.
					</p>
			<h4><a href="https://play.google.com/store/apps/details?id=com.amaze.QuizActivity&hl=en">Vocab World</a></h4>	
					<p>
			...
			<h4><a href="https://github.com/ashishjain1988/GBEER_Analysis_Pipeline/wiki">GBEER Analysis Pipeline</a></h4>	
					<p>
